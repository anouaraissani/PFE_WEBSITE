...
const monthNames = [
  ...
  const generateColors = (count, opacity) => {
    const palette = chroma
     .scale(["#2f8bcc", "#2A4858", "#58508d", "#ffa600", "#bc5090", "d13e56"])
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    filterCumule.addEventListener("change", function () {
      ...
      if (selectedFilter === "year") {
        route = "/dashboard/api/dataR";
      } else if (selectedFilter === "month") {
        route = "/dashboard/api/dataRMois";
      }
  ...
  function generateCharts(data) {
    // --------------------------------------------------------------------------------------------------
    // Taux
    const taux = document.getElementById('amount');
    ...
    myBarChart1 = new Chart("r-bar-chart1", {
      type: "bar",
      data: chartData1,
      options: {
        responsive: true,
    ...
    myBarChart2 = new Chart("r-bar-chart2", {
      type: "bar",
      data: chartData2,
      options: {
        responsive: true,
    ...
    myDoughnutChart = new Chart("r-doughnut-chart", {
      type: "doughnut",
      data: chartData3,
      options: {
        responsive: true,
