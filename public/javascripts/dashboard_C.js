...
const monthNames = [
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const filterCumule = document.getElementById("filterType-page1");
    console.log(filterCumule);
    let route = "/dashboard/api/dataC";
  
    filterCumule.addEventListener("change", function () {
      const selectedFilter = filterCumule.value;
      console.log(selectedFilter);
      if (selectedFilter === "year") {
        route = "/dashboard/api/dataC";
      } else if (selectedFilter === "month") {
        route = "/dashboard/api/dataCMois";
      }
  ...
  function generateCharts(data) {
    // --------------------------------------------------------------------------------------------------
    // Taux
    const taux = document.getElementById('c-performance');
    ...
    myBarChart1 = new Chart("c-bar-chart1", {
      type: "bar",
      data: chartData1,
      options: {
        responsive: true,
    ...
    myBarChart2 = new Chart("c-bar-chart2", {
      type: "bar",
      data: chartData2,
      options: {
        responsive: true,
    ...
    myDoughnutChart = new Chart("c-doughnut-chart", {
      type: "doughnut",
      data: chartData3,
      options: {
        responsive: true,
